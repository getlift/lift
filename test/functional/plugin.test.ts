...
describe('serverless plugin', () => {
    ...
    it('should add SQS resources', async function() {
        ...
        const actual = loadFile('queues/.serverless/cloudformation-template-update-stack.json');
    ...
    it('should add DB instance resources', async function() {
        ...
        const actual = loadFile('db/instance/.serverless/cloudformation-template-update-stack.json');
    ...
    it('should add DB cluster resources', async function() {
        ...
        const actual = loadFile('db/cluster/.serverless/cloudformation-template-update-stack.json');
    ...
    it('should add serverless DB resources', async function() {
        ...
        const actual = loadFile('db/serverless/.serverless/cloudformation-template-update-stack.json');
